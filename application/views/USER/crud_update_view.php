    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <form action="create" method="POST">
                <tr>
                    <td><b><?php echo $model->labels['id_user']; ?></b></td>
                    <td>:</td>
                    <td><b><input type="text" name="id_user" size="30" maxlength="30" value="<?php echo $model->id_user; ?>" /></b></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['nama_lengkap']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="nama_lengkap" size="30" maxlength="30" value="<?php echo $model->nama_lengkap; ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['username']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="username" size="30" maxlength="30" value="<?php echo $model->username; ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['password']; ?></td>
                    <td>:</td>
                    <td><input type="password" name="password" size="30" maxlength="35" value="<?php echo $model->password; ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['email']; ?></td>
                    <td>:</td>
                    <td> <input type="email" name="email" size="30" maxlength="50" value="<?php echo $model->email; ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['hp']; ?></td>
                    <td>:</td>
                    <td> <input type="text" name="hp" size="30" maxlength="25" value="<?php echo $model->hp; ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['level']; ?></td>
                    <td>:</td>
                    <td> <input type="level" name="level" size="30" maxlength="30" value="<?php echo $model->level; ?>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><b><input type="submit" name="btnSubmit" value="SIMPAN"/>
