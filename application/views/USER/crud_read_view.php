    ...
    <div class="content-wrapper">
        <div class="container">
           <center>
             ...
             <p><b><a href="<?php echo base_url()?>user/create"><span class="glyphicon glyphicon-user"></span> TAMBAH DATA</a></b></p>
...
foreach($rows as $row){
    ...
    <tr>
        ...
        <td align="center"><a href="<?php echo base_url()?>user/update/<?php echo $row->id_user; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
        <td><a style="color: #d63031" href="<?php echo base_url()?>user/delete/<?php echo $row->id_user;  ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
    </tr>
    <?php
}
?>
