...
<header>
    ...
    <div class="content-wrapper">
        <div class="container">
           <center>
             <b><h2 style="font-family: Agency; font-size: 28px;">DATA SISWA</h2></b>
              <p><b><a style="color: #d63031; font-size: 18px;" href="<?php echo base_url()?>Siswa/updateAll"><span class="glyphicon glyphicon-refresh"></span> PERBARUI KELAS SISWA</a></b></p>
             <p><b><a href="<?php echo base_url()?>Siswa1/input"><span class="glyphicon glyphicon-user"></span> TAMBAH DATA</a></b></p>
  <form  action="home" method="post" style="text-align: center;">
            ...
            <table style="text-align: center" width="800px"  border="1">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url(); ?>Siswa/detail/<?php echo $row->nis;?>">DETAIL</a></td>
                    <td><a href="<?php echo base_url(); ?>Siswa1/edit/<?php echo $row->nis;?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                    <td><a style="color: #d63031" href="<?php echo base_url(); ?>Siswa1/delete/<?php echo $row->nis;?>"><span class="glyphicon glyphicon-remove"></span></a></td>
                </tr>
                <?php 
                endforeach;?>
            </table>
