    ...
    <div class="content-wrapper">
        <div class="container">
           <center>
             ...
             <p><b><a href="<?php echo base_url()?>Siswa3/input"><span class="glyphicon glyphicon-user"></span> TAMBAH DATA</a></b></p>
            ...
            <table style="text-align: center"  width="800px"   border="1">
                ...
                <tr>
                   ...
                   <td><a href="<?php echo base_url(); ?>Siswa/detail/<?php echo $row->nis;?>">DETAIL</a></td>
                    <td><a href="<?php echo base_url(); ?>Siswa3/edit/<?php echo $row->nis;?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                    <td><a style="color: #d63031" href="<?php echo base_url(); ?>Siswa3/delete/<?php echo $row->nis;?>"><span class="glyphicon glyphicon-remove"></span></a></td>
                </tr>
                <?php $no++;
                endforeach;?>
            </table>
