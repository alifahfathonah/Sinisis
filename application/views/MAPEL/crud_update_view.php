    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <form action="create" method="POST">
                <tr>
                    <td><?php echo $model->labels['id_mapel']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="id_mapel" size="30" maxlength="100" value="<?php echo $model->id_mapel; ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['nama_mapel']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="nama_mapel" size="30" maxlength="100" value="<?php echo $model->nama_mapel; ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $model->labels['kkm']; ?></td>
                    <td>:</td>
                    <td><input type="text" name="kkm" size="30" maxlength="10" value="<?php echo $model->kkm; ?>" /></td>
                </tr>
                <tr>
