...
<header>
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="font-size: 18px">
                    <a style="color: white" href="<?php echo base_url()?>Siswa/index"><strong style="font-family:Times New Roman;"><i>Sistem Penilaian Siswa</i></strong></a>
                    &nbsp;&nbsp;
                </div>
            </div>
        </div>
    ...
    <div class="content-wrapper">
        <div class="container">
            <center>
             <b><h2 style="font-family: Agency; font-size: 28px;">DATA MAPEL</h2></b>
<p><b><a href="<?php echo base_url()?>mapel/create"><span class="glyphicon glyphicon-plus"></span> TAMBAH DATA</a></b></p>
...
foreach($rows as $row){
    ...
    <tr>
        ...
        <td align="center"><a href="<?php echo base_url()?>mapel/update/<?php echo $row->id_mapel; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
       <td><a style="color: #d63031"  href="<?php echo base_url()?>mapel/delete/<?php echo $row->id_mapel;  ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
    </tr>
    <?php
}
?>
